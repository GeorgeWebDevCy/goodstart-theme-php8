<?php
	...
	if ( is_admin() && isset($_GET['activated'] ) && $pagenow == 'themes.php' ) {
		$theme_logo = THEME_IMAGE_URL."GoodStart_dark.png";
		$theme_logo_f = THEME_IMAGE_URL."logo-footer.png";
		$favicon = THEME_IMAGE_URL."favicon.ico";
		$banner = '	<a href="http://www.different-themes.com" target="_blank"><img src="'.esc_url(THEME_IMAGE_URL.'728x90.jpg').'" alt="" title="" /></a>';
		...
		df_update_option(THEME_NAME.'_top_banner', 'on', true);
		df_update_option(THEME_NAME.'_top_banner_code', $banner, true);
		...
		df_update_option(THEME_NAME.'_color_1', '349dc9', true);
		df_update_option(THEME_NAME.'_color_2', '349dc9', true);
		df_update_option(THEME_NAME.'_color_3', '349dc9', true);
		df_update_option(THEME_NAME.'_breakingSlider', 'dark', true);
		df_update_option(THEME_NAME.'_mainMenu', 'dark', true);
		df_update_option(THEME_NAME.'_topMenu', 'dark', true);
		df_update_option(THEME_NAME.'_topHeader', 'light', true);

		df_update_option(THEME_NAME.'_body_color', 'f1f1f1', true);
	
		//df_update_option(THEME_NAME.'_default_cat_color', '349dc9', true);
		...
		df_update_option(THEME_NAME.'_postViews', 'custom', true);
		df_update_option(THEME_NAME.'_postControls', 'custom', true);
		...
		df_update_option(THEME_NAME.'_subcount', "4", true);
