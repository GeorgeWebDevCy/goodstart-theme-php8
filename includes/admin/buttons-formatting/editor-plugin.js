...
var differentthemesButtons=[
		...
		},
		{
			...
			allowSelection:false,
			fields:[{id:'style', name:'Style', values:['Colored', 'Default']},{id:'title-1', name:'Title: '},{id:'text', name:'Text: ', toggles:true}],
			generateHtml:function(obj){
				var x = jQuery('#df-toggles').val();  
				var output = '[accordion style="'+obj.style.toLowerCase()+'"]';
				for(e = 1; e <= x; e++) {
					output+= '[acc ';
		...
		},		
		{
			...
			title:'Service Box',
			allowSelection:false,
			fields:[{id:'icon', name:'Icon', values:df_icons()},{id:'align', name:'Align', values:['Left', 'Center', 'Right']},{id:'color', name:'Color', value:'264C84', colorpalette:true },{id:'title', name:'Title'},{id:'text', name:'Text', textarea:true}],
			generateHtml:function(obj){
		...
		},
		{
			...
			title:'Alert Box',
			allowSelection:false,
			fields:[{id:'icon', name:'Icon', values:df_icons()},{id:'text', name:'Text', textarea:true},{id:'color', name:'Color', values:['Green', 'Blue', 'Red', 'Yellow']}],
			generateHtml:function(obj){
		...
		},
		{
			...
			title:'Insert Tabs',
			allowSelection:false,
			fields:[{id:'style', name:'Style', values:['Colored', 'Default']},{id:'title-1', name:'Title: '},{id:'text', name:'Text: ', tabs:true}],
			generateHtml:function(obj){
				var x = jQuery('#df-tabs').val();  
				var output = '[tabs style="'+obj.style.toLowerCase()+'"]';
				for(e = 1; e <= x; e++) {
					output+= '[tab ';
					output+= 'title ="'+jQuery('#differentthemes-shortcode-title-'+e).val()+'"]';
					output+= jQuery('#differentthemes-shortcode-text-'+e).val();
