...
array(
	"type" => "checkbox",
	"title" => esc_html__("Allow to Output JavaScript and All HTML tags in Dynamic Data in Theme:", THEME_NAME),
...
array(
	...
	"info" => esc_html__("The API Key You Can Get Here:", THEME_NAME)." <a href='https://developer.worldweatheronline.com/auth/register' style='color:#fff' target='_blank'>".esc_html__("Register API Key", THEME_NAME)."</a>",
...
array(
	"type" => "checkbox",
	"title" => esc_html__("Show placeholder thumbnail, when no thumbnail is available:", THEME_NAME),
...
array(
	...
	"sample" => '<a href="http://www.different-themes.com" target="_blank"><img src="'.esc_url(THEME_IMAGE_URL.'728x90.jpg').'" alt="" title="" /></a>',
	"id" => $different_themes_managment->themeslug."_top_banner_code",
	"protected" => array(
		array("id" => $different_themes_managment->themeslug."_top_banner", "value" => "on")
	)
),
...
if(function_exists('different_theme_gallery_active')) {
	array_push($differentThemes_general_options[2]['subname'], array("slug"=>"gallery", "name"=>esc_html__("Gallery", THEME_NAME)));
}
