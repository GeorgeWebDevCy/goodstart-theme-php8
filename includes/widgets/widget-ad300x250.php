...
class tz_ad300_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo '<div class="widget_banner_300x250">';
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e('Title:', THEME_NAME) ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" value="<?php echo esc_attr($instance['title']); ?>" />
		</p>
		<!-- Ad image url: Text Input -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'ad' )); ?>"><?php esc_html_e('Ad image url:', THEME_NAME) ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'link' )); ?>"><?php esc_html_e('Ad link url:', THEME_NAME) ?></label>
