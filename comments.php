...
<?php //You can start editing here. ?>
        ...
        <div id="comments">
            <div class="block_title">
                <h2><?php comments_number(esc_html__('0 Comments', THEME_NAME), esc_html__('1 Comment', THEME_NAME), esc_html__('% Comments', THEME_NAME)); ?></h2>
            </div>
	...
	<?php if ( comments_open() ) : ?>
		 <div id="respond">
            <div class="block_title">
                <h2><?php esc_html_e( 'Leave a Reply', THEME_NAME );?></h2>
            </div>
