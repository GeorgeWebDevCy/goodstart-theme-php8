...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	function different_themes_scripts() { 
		...
		wp_enqueue_style("popup", THEME_CSS_URL."popup.css", Array());
		wp_enqueue_style("owlslider", THEME_CSS_URL."owlslider.css", Array());
		...
		wp_enqueue_script("owlcarousel" , THEME_JS_URL."jquery.owlcarousel.min.js", Array('jquery'), '', true);
		wp_enqueue_script("magnific" , THEME_JS_URL."jquery.magnific.popup.min.js", Array('jquery'), '', true);
		if(is_singular() || is_page_template('template-homepage.php')) {
			wp_enqueue_script("parallax" , THEME_JS_URL."jquery.parallax.min.js", Array('jquery'), '', true);	
		}

		wp_enqueue_script(THEME_JS_URL."-scripts" , THEME_JS_URL."jquery.init.js", Array('jquery'), "", true);
