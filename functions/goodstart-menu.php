		...
		"blocks" => array(
			array(
				"options" => array(
					...
					array(
						"type" => "title",
						"title" => esc_html__("Post/Page Image PopUp View", THEME_NAME),
						"skip_templates" => array("homepage","contact","about","gallery-1","portfolio","archive"),
						"page_type" => array("page","post","!blog"),
					),
					array(
					...
					*/
					...
					array(
						"type" => "title",
						"title" => esc_html__("Show Post Controls", THEME_NAME),
						"page_type" => array("post")
					),
					array(
						"type" => "radio",
					...
					array(
						"type" => "title",
						"title" => esc_html__("Header type", THEME_NAME),
						"page_type" => array("homepage"),
					),
					array(
						"type" => "radio",
						"id" => "_".$differentThemes_meta_fields->themeslug."_headerType",
						"radio" => array(
							array("title" => esc_html__("Off:", THEME_NAME), "value" => "off"),
							array("title" => esc_html__("Slider:", THEME_NAME), "value" => "slider"),
							array("title" => esc_html__("Grid news:", THEME_NAME), "value" => "grid"),
							array("title" => esc_html__("News Carousel:", THEME_NAME), "value" => "carousel"),
							array("title" => esc_html__("Parallax Image:", THEME_NAME), "value" => "parallax"),
						),
						"std" => "off",
						"page_type" => array("homepage"),
					),
					...
					array(
						"type" => "input",
						"title" => esc_html__("Main slider post count", THEME_NAME),
						"id" => "_".$differentThemes_meta_fields->themeslug."_post_count",
						"std" => "5",
						"page_type" => array("homepage"),						
						"protected" => array(
							array("dataType" => 'meta', "id" => "_".$different_themes_managment->themeslug."_headerType", "value" => "slider")
						)
					),
					array(
						"type" => "input",
						...
						"page_type" => array("homepage"),						
						"protected" => array(
							array("dataType" => 'meta', "id" => "_".$different_themes_managment->themeslug."_headerType", "value" => "carousel")
						)
					),
					array(
						"type" => "title",
						...
						"page_type" => array("homepage"),						
						"protected" => array(
							array("dataType" => 'meta', "id" => "_".$different_themes_managment->themeslug."_headerType", "value" => "grid")
						)
					),
					array(
						"type" => "radio",
						"id" => "_".$differentThemes_meta_fields->themeslug."_grid_bgType",
						"radio" => array(
							array("title" => esc_html__("Color:", THEME_NAME), "value" => "color"),
							array("title" => esc_html__("Image:", THEME_NAME), "value" => "image"),
						),
						"page_type" => array("homepage"),						
						"protected" => array(
							array("dataType" => 'meta', "id" => "_".$different_themes_managment->themeslug."_headerType", "value" => "grid")
					...
					array(
						...
						"id"=> '_'.$differentThemes_meta_fields->themeslug."_grid_color",
						"std" => "F1F1F1",
						"page_type" => array("homepage"),						
						"protected" => array(
							array("dataType" => 'meta', "id" => "_".$different_themes_managment->themeslug."_grid_bgType", "value" => "color")
						)
					),	
					array(
						"type" => "upload",
						"title" => esc_html__("Image:",THEME_NAME),
						"id"=> '_'.$differentThemes_meta_fields->themeslug."_grid_image",
						"page_type" => array("homepage"),						
						"protected" => array(
							array("dataType" => 'meta', "id" => "_".$different_themes_managment->themeslug."_grid_bgType", "value" => "image")
						)
					),	
					...
					array(
						"type" => "radio",
						"id" => "_".$differentThemes_meta_fields->themeslug."_slider_bgType",
						"radio" => array(
							array("title" => esc_html__("Color:", THEME_NAME), "value" => "color"),
							array("title" => esc_html__("Image:", THEME_NAME), "value" => "image"),
						),
					...
					array(
						"type" => "color",
						"title" => esc_html__("Color:",THEME_NAME),
						"id"=> '_'.$differentThemes_meta_fields->themeslug."_slider_color",
						"std" => "F1F1F1",
						"page_type" => array("homepage"),						
						"protected" => array(
							array("dataType" => 'meta', "id" => "_".$different_themes_managment->themeslug."_slider_bgType", "value" => "color")
						)
					),	
					array(
						"type" => "upload",
						"title" => esc_html__("Image:",THEME_NAME),
						"id"=> '_'.$differentThemes_meta_fields->themeslug."_slider_image",
						"page_type" => array("homepage"),						
						"protected" => array(
							array("dataType" => 'meta', "id" => "_".$different_themes_managment->themeslug."_slider_bgType", "value" => "image")
						)
					),	
					...
					array(
						"type" => "radio",
						"id" => "_".$differentThemes_meta_fields->themeslug."_carousel_bgType",
						"radio" => array(
							array("title" => esc_html__("Color:", THEME_NAME), "value" => "color"),
							array("title" => esc_html__("Image:", THEME_NAME), "value" => "image"),
						),
					...
					array(
						"type" => "color",
						"title" => esc_html__("Color:",THEME_NAME),
						"id"=> '_'.$differentThemes_meta_fields->themeslug."_carousel_color",
						"std" => "F1F1F1",
						"page_type" => array("homepage"),						
						"protected" => array(
							array("dataType" => 'meta', "id" => "_".$different_themes_managment->themeslug."_carousel_bgType", "value" => "color")
						)
					),	
					array(
						"type" => "upload",
						"title" => esc_html__("Image:",THEME_NAME),
						"id"=> '_'.$differentThemes_meta_fields->themeslug."_carousel_image",
						"page_type" => array("homepage"),						
						"protected" => array(
							array("dataType" => 'meta', "id" => "_".$different_themes_managment->themeslug."_carousel_bgType", "value" => "image")
						)
					),	
					...
					*/
					...
					array(
						...
						"radio" => array(
							...
							array("title" => esc_html__("Timeline:", THEME_NAME), "value" => "4"),
					...
					array(
						"type" => "title",
						"title" => esc_html__("Single Image Type", THEME_NAME),
						"page_type" => array('post', 'page'),
						"skip_templates" => array("homepage","contact","about","archive","gallery-1")
					...
					array(
						"type" => "radio",
						"id" => "_".$differentThemes_meta_fields->themeslug."_parallax",
						"radio" => array(
							array("title" => esc_html__("Default:", THEME_NAME), "value" => "no"),
							array("title" => esc_html__("Parallax:", THEME_NAME), "value" => "yes"),
						),
						"std" => 'no',
						"page_type" => array('post', 'page'),
						"skip_templates" => array("homepage","contact","about","archive","gallery-1")
					...
					*/
					...
					array(
						"type" => "title",
						"title" => esc_html__("Show This Post In Main Slider/Grid?", THEME_NAME),
						"page_type" => array("post")
					),
					array(
						"type" => "checkbox",
...
//gallery images
$box_array[] = array( 'id' => 'post-slider-images', 'title' => ''.$image.esc_html__("Gallery Images", THEME_NAME), 'page' => DF_POST_GALLERY, 'context' => 'side', 'priority' => 'low', 'fields' => array(array('name' => "", 'std' => '', 'id' =>  'different_themes_gallery_gallery_images', 'type'=> 'image_select' ) ), 'size' => 0,'first' => 'no'  );
	...
	foreach ($fields['fields'] as $field) {
		...
		switch ($field['type']) {
			case 'slider_image_box':
				echo '<input class="upload input-text-1 df-upload-field" type="text" name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" value="',  $meta ? esc_attr(df_remove_html_slashes($meta)) :  esc_attr(df_remove_html_slashes($field['std'])), '" style="width: 140px;"/><a href="#" class="df-upload-button">Button</a>';
				break;
			case 'image_select':
